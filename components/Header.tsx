    ...
    <header className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 no-print ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-md py-5' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            onClick={handlePrint}
            className="flex items-center gap-2 px-5 py-2 bg-[#004a99] text-white text-xs font-bold rounded-full hover:bg-blue-800 transition-all shadow-md active:scale-95"
          >
